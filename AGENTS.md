...
Tosh Company is the umbrella ecosystem for independent macOS products including NotchinTosh, LaunchinTosh, LockinTosh, SwitchinTosh, and CleaninTosh.
This root project owns shared identity, styles, app registration, marketplace direction, and cross-app contracts.
Each app remains independently buildable and keeps its own source, tests, feature docs, and release cycle.
The Tosh Marketplace will later provide public discovery and host-specific signed components for compatible apps.
